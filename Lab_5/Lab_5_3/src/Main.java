...
class ModelNullException extends Exception {
    ...
    public ModelNullException(String str) {
        this.str = str;
    }

    public static void GetYear(int num) throws ModelNullException {

        if (num > 2023 | num < 1700) throw new ModelNullException("Введен некорректный год:" + num);
...
public class Main {
        ...
        public static void main(String[] args) {
            ...
            String s = "";
            try {
                s = input.nextLine().toString();
                if (s.equals("")) {
                    throw new ModelNullException("Отсутствует название модели автомобиля");
                }
            ...
            n = input.nextInt();
            try {
              //  ModelNullException e=new ModelNullException();

                ModelNullException.GetYear(n);
