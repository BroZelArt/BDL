...
class QuadEquat {
    ...
    public void Root(){
        ...
        if ((-b+Math.sqrt(d))/(2*a) == Float.POSITIVE_INFINITY || (-b+Math.sqrt(d))/(2*a) == Float.NEGATIVE_INFINITY) {
...
public class Main {
    public static void main(String[] args) {
        ...
        for(int i=0;i<10;i++){
            ...
            throw new OutOfMemoryError("Выявлена нехватка памяти");
        }
        double min,max;
        int imin,imax;
        min=root[0][0];
        ...
        for (int i=0; i<10;i++){
            ...
            if (root[i][1]<min){
                ...
                throw new IndexOutOfBoundsException("Выявлен выход за пределы масисива " + 10);
            }
